...
// Rutas de paquete (más estables, evitan conflictos)
      ...
      appBar: AppBar(
        ...
        actions: [
          ...
          Padding(
            ...
            child: Center(
              child: _ConnectionChip(state: connState),
            ),
          )
        ],
      ),
                      ...
                      children: [
                              ...
                              : () async {
                                  ...
                                  if (id != null) {
                                    try {
                                      ...
                                      ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text('Error conectando: $e')));
                                    }
                                  }
                                },
                        ...
                        ElevatedButton(
                          onPressed: prov.bt.lastDeviceId == null
                              ...
                              : () async {
                                  try {
                                    await prov.connect(prov.bt.lastDeviceId!);
                                  } catch (e) {
                                    ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text('Error reintentando conexión: $e')));
                                  }
                                },
...
class _ConnectionChip extends StatelessWidget {
  final ConnectionStateBT state;
  const _ConnectionChip({Key? key, required this.state}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    Color color;
    switch (state) {
      case ConnectionStateBT.connecting:
        text = 'Conectando';
        color = Colors.orange;
        break;
      case ConnectionStateBT.connected:
        text = 'Conectado';
        color = Colors.green;
        break;
      case ConnectionStateBT.disconnected:
      default:
        text = 'Desconectado';
        color = Colors.red;
        break;
